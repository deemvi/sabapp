...
<head>
    ...
    <title>Sewa Alat Badminton</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            <div class="nav-header">
                <div class="brand-logo"><a href="<?php site_url('user') ?>"><b><img src="assets/images/logo-sab.jpg" alt="" width="150px"> </b><span class="brand-title">Sewa Alat</span></a>
                </div>
            ...
            <div class="header-content">
                ...
                <div class="header-right">
                    <ul>
                        ...
                        <li><a href="<?= site_url('auth/logout_user') ?>"><i class="icon-power"></i> <span>Logout</span></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="nk-sidebar">
        <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
                <li><a href="<?= site_url('user') ?>"><i class="mdi mdi-home"></i> <span class="nav-text">Dashboard</span></a>
                </li>
                <li><a href="<?= site_url('user/pembookingan') ?>"><i class="mdi mdi-clipboard-text"></i> <span class="nav-text">Booking</span></a>
                </li>
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i> <span class="nav-text">Sewa</span></a>
                    <ul aria-expanded="false">
                        <li><a href="<?= site_url('user/penyewaan') ?>">Penyewaan</a>
                        </li>
                        <li><a href="chart-morris.html">Pengembalian</a>
                        </li>
                    </ul>
                </li>
                <li><a href="<?= site_url('user/artikel') ?>"><i class="mdi mdi-widgets"></i> <span class="nav-text">Artikel</span></a>
                </li>
            </ul>
        </div>
        <!-- #/ nk nav scroll -->
