...
<div class="content-body">
    <div class="container-fluid">
        <div class="col-lg-9">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Form Pinjam Produk</h4>
                    ...
                    <?php foreach($data as $produk): ?>
                        <form method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nama_produk" class="form-control" value="<?= $produk->nama_produk ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Harga Produk</label>
                                <div class="col-sm-10">
                                    <input type="number" name="harga_produk" class="form-control" value="<?= $produk->harga_produk ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="custom-select mr-sm-2" name="jenis_produk" id="" readonly>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jumlah Sewa Alat</label>
                                <div class="col-sm-10">
                                    <input type="number" name="jumlah" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Tujuan Alamat</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <input type="submit" name="btn_pinjam" value="Pinjam Alat" class="btn btn-dark">
                                </div>
                            </div>
                        </form>
                        <?php endforeach; ?>
